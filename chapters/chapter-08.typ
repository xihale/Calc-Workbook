...
#question(
  ...
  p: [
    $bold(a) times bold(b)=bold(a) times bold(c) => bold(a) times (bold(b)-bold(c))=bold(0) => (bold(b)-bold(c)) || bold(a)$，不一定有 $bold(b)=bold(c)$。
  ],
)
...
#question(
  [
    ...
    A. $bold(a) || bold(b)$ 的充要条件 #quad B. $bold(a) perp bold(b)$ 的充要条件 \
    C. $bold(a) = bold(b)$ 的充要条件 #quad D. $bold(a) || bold(b)$ 的必要但不充分条件
  ],
  p: [
...
#question(
  ...
  p: [
    $bold(d) || (bold(a) times bold(b)) = (7, -7, -7)$，设 $bold(d) = k (1, -1, -1)$。
...
#question(
  [
    ...
    A. $L_1 perp L_2$ #quad B. $L_1 || L_2$ #quad C. $L_1$ 与 $L_2$ 相交但不垂直 #quad D. $L_1$ 与 $L_2$ 为异面直线
  ],
  p: [
    $bold(s_1) = (1, 2, -1) times (-2, 1, 1) = (3, 1, 5)$；$bold(s_2) = (3, 6, -3) times (2, -1, -1) = (-9, -3, -15)$。
    因 $bold(s_2) = -3 bold(s_1)$，故 $L_1 || L_2$。
  ],
  a: [B.],
)
...
#question(
  ...
  p: [
    $bold(s) = (1, 1, 3) times (1, -1, -1) = (2, 4, -2) || (1, 2, -1)$；$bold(n) = (1, -1, -1)$。
...
#question(
  ...
  p: [
    ...
    $bold(n) = bold(s_1) times bold(s_2) = (-1,1,-1) || (1,-1,1)$。
...
#question(
  ...
  p: [
    点 $M_0(1, 0, 2), bold(s) = (0, -3, -3) || (0, 1, 1), P(3, -1, 2) => arrow(M_0 P) = (2, -1, 0)$。
