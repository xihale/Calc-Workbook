...
#question(
  ...
  a: [
    ...
    p: [
      ...
      $t(sqrt(2-e^t)-1)$。 \
      由连续性可见 $sqrt(2-e^t)-1 -> 0$，故整个乘积趋于 $0$。 \
      (3) 令 $u=x y$，则 \
...
#question(
  [
    ...
    A. $-((sqrt(2)))/(8)$ #quad B. $(1)/(4)$ #quad C. $-(1)/(2)$ #quad D. $(1)/(2)$
  ],
  p: [
    $f_x' =(1)/((2 sqrt(((y))/((x)))) dot (-((y))/((x^2))))= -(1)/((2 sqrt(((x))/((y))) dot y))/(x^2)$。代入 $(2, 1)$ 得 $f_x'(2,1) = -(1)/((2 sqrt(2) dot 1))/(4)= -(sqrt(2))/(8)$。
  ],
)
...
#question(
  ...
  p: [
    ...
    则 $z=e^(phi)$。 \
    由链式法则 \
    $z_x=e^(phi) phi_x, z_y=e^(phi) phi_y$。 \
    计算 \
    $phi_x=2x y, phi_y=x^2+3y^2$， \
    故 \
    $z_x=2x y e^(y(x^2+y^2)), z_y=(x^2+3y^2)e^(y(x^2+y^2))$。 \
    因而 \
...
#question(
  ...
  p: [
    $u_x' =((partial u))/((partial x))+((partial u))/(((partial z) dot (partial z)))/((partial x))= z(x-y)^(z-1) + (x-y)^z ln(x-y) dot 2x$。 \
...
#question(
  ...
  p: [
    ...
    再对 $y$ 求偏导： \
    $((partial^2 z))/((partial x partial y))=((partial f_1'))/((partial y))+((partial(((1)/(y))f_2')))/((partial y))$。 \
    其中 \
    $((partial f_1'))/((partial y))=f_12'' u_(2y)=f_12''(-(x)/(y^2))$； \
    $((partial(((1)/(y))f_2')))/((partial y))=-((1)/(y^2))f_2'+((1)/(y))f_22'' u_(2y) =-((1)/(y^2))f_2'-((x)/(y^3))f_22''$。 \
    合并得 \
    $((partial^2 z))/((partial x partial y))=-(1)/(y^2 f_2')-(x)/(y^2 f_12'')-(x)/(y^3 f_22'')$。
  ],
    )
...
#question(
  ...
  p: [
    $z = x + y - e^x$。 $((dif z))/((dif t))=((1 - e^x) (dif x))/((dif t))+((dif y))/((dif t))$。 \
  ...
  p: [
    记 $F = x y z - e^(x+y) = 0$。则 $y_x = -(F_x)/(F_y)$。 \
  ...
  a: [$((dif y))/((dif x))=-(x(6z+1))/((2y(3z+1)))$，$((dif z))/((dif x))=(x)/((3z+1))$。],
  p: [
  ...
  a: [$((partial u))/((partial x))=((u f_1' (1 - 2 y v g_2') - f_2' g_1'))/(Delta)$，$((partial v))/((partial x))=(g_1' (x f_1' + u f_1' - 1))/(Delta)$。],
  p: [
  ...
  p: [
    点 $(2, 0,(pi)/(2))$ 对应 $t =(pi)/(2)$。切向量 $arrow(v) = (2 cos t, -4 sin t, 1)$。 \
  ...
  a: [$bold(grad)f(1,2)=(2,2)$，$D_l f(1,2)=(14)/(5)$。],
  p: [
...
#question(
  [
    ...
    A. $1$ #quad B. $-(1)/(7)$ #quad C. $(1)/(2)$ #quad D. $-(1)/(2)$
  ],
  p: [
    对方程求导： \
...
#question(
  [
    6. $lim_((x,y) arrow (0,0)) (1 + sin x y )^((1)/((x y))) =$ #ans[$e$]
  ],
  p: [
